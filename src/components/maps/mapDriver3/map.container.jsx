...
function MapDriver3Container() {
  ...
  const map = (
    <Map className="map-template-3" center={position} zoom={13} zoomControl={false} attributionControl={false}>
      <TileLayer
        url={styleMap2}
      />
...
export default MapDriver3Container;
